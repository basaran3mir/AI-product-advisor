...
def main() -> None:
    parser = argparse.ArgumentParser(description="Clean and encode o1_filtered_dataset.csv.")
    parser.add_argument("--input", default="o1_filtered_dataset.csv")
    parser.add_argument("--clean-out", default="o2_cleaned_dataset.csv")
    parser.add_argument("--encoded-out", default="o3_encoded_dataset.csv")
    parser.add_argument("--report-out", default="encoding_report.json")
    parser.add_argument(
        "--encoding",
        default="onehot",
